...
export default function AdminLayout({ children }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#fff9f5', paddingBottom: isMobile ? '80px' : 0 }}>
      ...
      {/* Main Content */}
      <main style={{ flex: 1, padding: isMobile ? '1rem' : '2rem', maxWidth: '1400px', margin: '0 auto', width: '100%' }}>
        ...
        <header style={{ 
          ...
          {isMobile && (
            <Link href="/admin" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <div style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'var(--gradient)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ color: '#fff', fontWeight: 900, fontSize: '0.8rem' }}>V</span>
              </div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', padding: '0.5rem 1rem', background: '#fff', borderRadius: '100px', border: '1px solid #ffe2cc', boxShadow: '0 2px 6px rgba(0,0,0,0.04)' }}>
              <div style={{ width: '28px', height: '28px', borderRadius: '50%', background: 'var(--gradient)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '0.75rem', fontWeight: 800 }}>A</div>
            </div>
          </div>
        </header>
